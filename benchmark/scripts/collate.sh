...
for file in `ls generated/*rocq*.log`; do python3 scripts/rocq_log_to_csv.py $file csv/$(basename $file).csv; done
for file in `ls generated/*idris*.log`; do python3 scripts/idris_log_to_csv.py $file csv/$(basename $file).csv; done
