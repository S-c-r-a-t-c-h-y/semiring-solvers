...
There is an isomorphism of $\mathcal{T}$-models over $X$ $$\la FX, \var_{FX} \ra \cong \la \bigr(\Term_{\Sigma_{\mathcal{T}}} X \bigl) / \bigr(X \vdash_{\mathcal{T}}\bigl) =: Q, \var' \ra$$ with $\var': {X} \to {Q}$ given by ${x} \mapsto {[\var x]}$. Therefore free algebras represent terms modulo semantics.
