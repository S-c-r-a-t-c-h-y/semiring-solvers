...
The \ring tactic is capable of dealing both with commutative rings and commutative semirings, under the same implementation. To unify both structure, they introduce \emph{almost-rings}, an intermediate structure similar to rings and semirings.
...
The \textsc{Frex} approach to algebraic simplification lets us tackle many more theories than the Rocq \ring tactic can. In Table~\ref{tbl:combination-table}, we show examples of models for the different distributive combinations of mere/commutative mere/involutive semigroups, monoids and groups. $\Circled{\mathrm{Circled}}$ are the theories that the \ring tactic can handle. Only the commutative semiring/ring corner is covered by reflection-based ring solving, whereas Frex extends to semigroup/monoid/group and involutive variants.
