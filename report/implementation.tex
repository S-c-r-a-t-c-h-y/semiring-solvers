...
Following the work of \cite{idris_frex}, we tested our implementation to find the instantaneity (0.1s), interactivity (1s) and attention (10s) tresholds described by \cite{nielsen:usability-engineering}. This is important as developping in Idris2 is interactive and our tool is meant to discharge the user of painful arithmetic proofs.

\textsc{Frex}'s checking time\footnote{We used an Intel Core Ultra 7 255HX machine with 16GB memory, running Idris 2 version 0.8.0-6a54860ee on Debian Linux 13.} remains under the instantaneity treshold for terms of size 30 to 60 depending on the number of free variables, as pictured in Figure~\ref{fig:perf-single}. This is more than sufficient to deal with the typical equalities that arise in dependently typed programs.
...
\begin{itemize}
  \item \textcite{idris_frex} mentioned a performance bottleneck in Idris2's evaluator, this was four years ago and the developpment of Idris2 probably eliminated this bottleneck.
